...
<body>
	...
	<td>' . $row['fsbi'] . '</td>
	<td>' . $row['fcbi'] . '</td>
	<td><form action="/registration/pdf/reciept.php/?roll='.$row['roll'].'" method=post><button type=submit class="btn btn-primary text-white"> Download Reciept</button></form></td>
	</tr>
	';
			$sl++;
		}
